...
hud_player_info_t	 g_PlayerInfoList[4096+1];	   // player info from the engine
extra_player_info_t  g_PlayerExtraInfo[4096+1];   // additional player info sent directly to the client dll
