...
{
	m_defaultModel = "models/w_medkit.mdl";
...
BOOL CHealthKit::MyTouch( CBasePlayer *pPlayer )
{
	...
	if ( pPlayer->TakeHealth(giveHealth, DMG_GENERIC, m_healthcap ) )
	{
		...
		if (pPlayer->GiveAmmo(25, "health", gSkillData.sk_ammo_max_medkit) != -1)
		{
...
void CWallHealth::Spawn()
{
	...
	m_iJuice = gSkillData.sk_healthcharger;
	pev->frame = 0;			
